...
export const subjects: Subject[] = [
  { _id: 's1', name: 'Development', slug: 'development', createdAt: '', updatedAt: '' },
  { _id: 's2', name: 'Travel', slug: 'travel', createdAt: '', updatedAt: '' },
];

export const topics: Topic[] = [
  { _id: 't1', subjectId: 's1', name: 'React & Redux', slug: 'react-redux', createdAt: '', updatedAt: '' },
  { _id: 't2', subjectId: 's1', name: 'Databases', slug: 'databases', createdAt: '', updatedAt: '' },
  { _id: 't3', subjectId: 's2', name: 'Australia', slug: 'australia', createdAt: '', updatedAt: '' },
];
